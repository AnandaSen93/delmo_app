...
class MyAccountEditView extends StatefulWidget {
  const MyAccountEditView({super.key});

  @override
  State<MyAccountEditView> createState() => _MyAccountEditViewState();
}

class _MyAccountEditViewState extends State<MyAccountEditView> {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          child: TextButton(
                            onPressed: () {},
                            child: Text("UPDATE → ", style: textStyleForButton),
                          ),
                        ),
                      ),
